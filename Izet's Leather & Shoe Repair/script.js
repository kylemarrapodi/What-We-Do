...
function handleSubmit(e) {
  e.preventDefault();
  alert("Thanks for reaching out! This is a design-proposal demo site, so this form isn't wired up yet — please call (203) 323-0319 to reach the real Izet's Leather & Shoe Repair.");
  e.target.reset();
}
// ── Gallery tabs ──
...
document.querySelectorAll('.feature-item, .service-item').forEach(el => observer.observe(el));
