...
e.preventDefault();
alert("Thank you! Your reservation request has been received. We'll be in touch shortly at the email or phone number you provided.");
e.target.reset();
}
// ── Gallery tabs ──
...
document.querySelectorAll('.room-card, .amenity-item, .lbi-card, .review-card').forEa
