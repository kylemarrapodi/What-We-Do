...
e.preventDefault();
alert("Thanks for reaching out! This is a design-proposal demo site, so this form isn't wired up yet — please call (609) 492-9616 to reach the real Hudson House Bar.");
e.target.reset();
}
// ── Gallery tabs ──
