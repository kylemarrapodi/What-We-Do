...
e.preventDefault();
alert("Thanks for reaching out! This is a design-proposal demo site, so this form isn't wired up yet — please call (806) 416-1283 to reach the real Shack BBQ.");
e.target.reset();
}
// ── Gallery tabs ──
