...
e.preventDefault();
alert("Thanks for reaching out! This is a design-proposal demo site, so this form isn't wired up yet — please call (806) 368-3603 to reach the real Capital Pizza (Tech Terrace).");
e.target.reset();
}
// ── Gallery tabs ──
