...
e.preventDefault();
alert("Thanks for reaching out! This is a design-proposal demo site, so this form isn't wired up yet — please call (203) 363-0804 to reach the real Casey's Tavern.");
e.target.reset();
}
// ── Gallery tabs ──
